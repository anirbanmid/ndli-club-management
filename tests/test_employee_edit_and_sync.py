...
class TestEmployeeEditAndSync(unittest.TestCase):
    ...
    def _get_employee_token(self, emp_id="EMP01", password="EmpNorth#2026"):
        status, res = self._post_json("/api/auth/login", {
            "email": emp_id,
            "password": password
        })
    ...
    def test_employee_forbidden_from_admin_management(self):
        ...
        emp_token = self._get_employee_token("EMP01", "EmpNorth#2026")
    ...
    def test_employees_roster_and_profile_endpoints(self):
        ...
        emp_token = self._get_employee_token("EMP04", "EmpEast#2026")
