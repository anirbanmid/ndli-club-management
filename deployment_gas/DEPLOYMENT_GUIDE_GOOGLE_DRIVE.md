...
| :--- | :--- | :--- | :--- |
| **Central Admin Office (IIT Kharagpur)** | `ADMIN01` | `admin@iitkgp.ac.in` | `Seed#Scrubbed-2026` *(or `Seed#Admin-Rotated2026`)* |
| **Regional Officer — North Zone** | `EMP01` | `emp01@ndli.iitkgp.ac.in` | `Seed#EMP01-Rotated2026` |
| **Regional Officer — Central Zone** | `EMP02` | `emp02@ndli.iitkgp.ac.in` | `Seed#EMP02-Rotated2026` |
| **Regional Officer — West Zone** | `EMP03` | `emp03@ndli.iitkgp.ac.in` | `Seed#EMP03-Rotated2026` |
| **Regional Officer — East Zone** | `EMP04` | `emp04@ndli.iitkgp.ac.in` | `Seed#EMP04-Rotated2026` |
| **Regional Officer — North East Zone** | `EMP05` | `emp05@ndli.iitkgp.ac.in` | `Seed#Scrubbed-2026` |
| **Regional Officer — South Zone 1** | `EMP06` | `emp06@ndli.iitkgp.ac.in` | `Seed#EMP06-Rotated2026` |
| **Regional Officer — South Zone 2** | `EMP07` | `emp07@ndli.iitkgp.ac.in` | `Seed#EMP07-Rotated2026` |
...
- Log in with `ADMIN01` and `Seed#Scrubbed-2026`.
- Verify:
...
- Verify:
  ...
  - Click on **EMP01 (Rohan Sharma)** to autofill credentials, type `Seed#EMP01-Rotated2026`, and sign in.
