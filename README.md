...
- **Password:** `Admin@IITKGP2026`
- **Role:** `ADMIN`

### 7 Regional Employees
| Employee ID | Name | Zone | Email | Pre-generated Password |
| :--- | :--- | :--- | :--- | :--- |
| `EMP01` | Rohan Sharma | North | `emp.north@ndli.edu.in` | `EmpNorth#2026` |
| `EMP02` | Pooja Verma | Central | `emp.central@ndli.edu.in` | `EmpCentral#2026` |
| `EMP03` | Amit Patel | West | `emp.west@ndli.edu.in` | `EmpWest#2026` |
| `EMP04` | Debabrata Ghosh | East | `emp.east@ndli.edu.in` | `EmpEast#2026` |
| `EMP05` | Mayanglambam Singh | North East | `emp.northeast@ndli.edu.in` | `EmpNEast#2026` |
| `EMP06` | K. Venkatesh | South 1 | `emp.south1@ndli.edu.in` | `EmpSouth1#2026` |
| `EMP07` | Ananya Nair | South 2 | `emp.south2@ndli.edu.in` | `EmpSouth2#2026` |
